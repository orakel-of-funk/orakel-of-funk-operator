...
// +kubebuilder:webhook:path=/mutate-orakel-ofunk-org-v1alpha1-namespacehardeningcheck,mutating=true,failurePolicy=fail,sideEffects=None,groups=orakel.ofunk.org,resources=namespacehardeningchecks,verbs=create;update,versions=v1alpha1,name=mnamespacehardeningcheck-v1alpha1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-orakel-ofunk-org-v1alpha1-namespacehardeningcheck,mutating=false,failurePolicy=fail,sideEffects=None,groups=orakel.ofunk.org,resources=namespacehardeningchecks,verbs=create;update,versions=v1alpha1,name=vnamespacehardeningcheck-v1alpha1.kb.io,admissionReviewVersions=v1
